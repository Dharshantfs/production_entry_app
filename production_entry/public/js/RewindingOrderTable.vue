...
const ITEM_PROCESS_KNOWN = new Set([
  "100", "102", "103", "104", "105", "106", "107", "108", "109", "211", "212", "213", "221", "222", "223", "224", "231", "232", "233", "241", "242", "251", "252", "253", "254", "255",
]);
const rawData = ref([]);
...
async function handleShiftDrop(targetShift) {
  ...
  try {
    const res = await frappe.call({
      method: "production_entry.production_planning.scheduler_api.assign_rewinding_shift",
...
async function fetchData() {
  ...
  try {
    ...
    const r = await frappe.call({
      method: "production_entry.production_planning.scheduler_api.get_rewinding_order_table_data",
      args,
    });
