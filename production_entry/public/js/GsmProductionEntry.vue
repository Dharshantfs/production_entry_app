      ...
      <main class="gpe-main gpe-card">
        <div class="gpe-header gpe-session-panel-main gpe-card-inner">
          ...
          <div v-if="shiftOpenPromptVisible" class="gpe-shift-not-started-banner">
            ...
            <button type="button" class="gpe-btn primary" :disabled="freezeGsmStartShift" :style="boardActionFrozenStyle(gsmBoardAccess, 'gsm_start_shift')" @click="guardedOpenShiftDialog">Start Shift</button>
          </div>
            ...
            <div class="gpe-header-fields gpe-header-fields-lg">
              ...
              <div v-if="(headerUnit || filterUnit) && !isMixingExcluded" class="gpe-wastage-recycle-btns">
                <button
                  type="button"
                  class="gpe-btn"
                  :disabled="!canOpenMixingSheet || freezeGsmMixingSheet"
                  :style="boardActionFrozenStyle(gsmBoardAccess, 'gsm_mixing_sheet')"
                  @click="guardedOpenMixingDialog"
                >Mixing Sheet</button>
              </div>
        ...
        <div class="gpe-toolbar">
          <div class="gpe-toolbar-left">
            ...
            <button type="button" class="gpe-btn" :disabled="freezeGsmRemoveRow" :style="boardActionFrozenStyle(gsmBoardAccess, 'gsm_remove_row')" @click="guardedRemoveTopRow">Remove Top Row</button>
            <button
              type="button"
          ...
          <div class="gpe-toolbar-right">
            ...
            <button type="button" class="gpe-btn" :disabled="!selectedEntries.length || freezeGsmShaftDetails" :style="boardActionFrozenStyle(gsmBoardAccess, 'gsm_shaft_details')" @click="guardedShaftDetails">Shaft Details</button>
