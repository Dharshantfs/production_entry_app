...
Use this module from hooks.py as ``production_entry.install`` — **not** ``production_entry.setup``,
because the latter name conflicts with the setuptools ``setup.py`` file at the app root.
