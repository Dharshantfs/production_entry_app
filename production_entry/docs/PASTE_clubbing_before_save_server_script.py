# Clubbing Sheet — Before Save
# DocType: Clubbing Sheet | Event: Before Save
# Paste ALL of this. Uses 4 spaces (no tabs). Do NOT use frappe._
...
if doc.items:
    ...
    # Client Script sets custom_lock_loading_sequence = 1 on a manual edit
    skip_auto_loading = int(doc.get("custom_lock_loading_sequence") or 0)

    if skip_auto_loading:
        pass
    elif doc.load_type == "Full Load":
        for item in doc.items:
