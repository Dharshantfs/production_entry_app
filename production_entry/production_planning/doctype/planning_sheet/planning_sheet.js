frappe.ui.form.on('Planning sheet', {
    ...
    toggle_221_fields: function(frm) {
        ...
        let required_by = {
            ...
            'custom_finishing': ['107', '255', '109', '200', '201', '202', '211', '212', '213', '217', '221', '222', '223', '224', '231', '233', '241', '242'],
            'bag_size': ['200', '201', '202', '211', '212', '213', '217', '221', '222', '223', '224', '231', '233', '241', '242']
        };
